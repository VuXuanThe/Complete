...
public class UpdateDataConectForStudentFragment extends Fragment {
    public final static String TAG = "UpdateDataConectForStudentFragment";
    private FragmentUpdateDataConectForTeacherBinding binding;
    private DataConnect dataConnect;
    private APIService apiService;

    public static UpdateDataConectForStudentFragment newInstance(Bundle data) {
        UpdateDataConectForStudentFragment fragment = new UpdateDataConectForStudentFragment();
        ...
        binding.btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(subject == null || tuition == null || numSession == null){
                    ...
                    dataConnect.setUpdate("Wait Teacher");
                    ...
                    builder.setPositiveButton("Xác nhận", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Data data = new Data(FirebaseAuth.getInstance().getCurrentUser().getUid(),Helper.STUDENT_TV + " " + dataConnect.getStudent().getStudentName() + " đã cập nhật thông tin lớp học" , "Confirm Request",
                                    dataConnect.getUidTeacher());

                            //create notice
                            Notice notice = new Notice("Cập Nhật", String.valueOf(System.currentTimeMillis()), dataConnect.getStudent().getStudentName() + " đã cập nhật dữ liệu môn học");
                    ...
                    builder.setMessage("Hệ thống sẽ gửi thông báo xác nhận đến " + Helper.TEACHER_TV + " " + dataConnect.getTeacher().getTeacherName());
